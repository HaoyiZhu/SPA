...
template <typename scalar_t, typename index_t>
  ...
  CUDA_KERNEL_LOOP_TYPE(index, nthreads, index_t) {
    ...
    scalar_t nw_val = static_cast<scalar_t>(0), ne_val = static_cast<scalar_t>(0), sw_val = static_cast<scalar_t>(0), se_val = static_cast<scalar_t>(0);
    scalar_t g2_nw_val = static_cast<scalar_t>(0), g2_ne_val = static_cast<scalar_t>(0), g2_sw_val = static_cast<scalar_t>(0), g2_se_val = static_cast<scalar_t>(0);
...
template <typename scalar_t, typename index_t>
  ...
  CUDA_KERNEL_LOOP_TYPE(index, nthreads, index_t) {
    ...
    scalar_t tnw_val = static_cast<scalar_t>(0), tne_val = static_cast<scalar_t>(0), tsw_val = static_cast<scalar_t>(0), tse_val = static_cast<scalar_t>(0);
    scalar_t bnw_val = static_cast<scalar_t>(0), bne_val = static_cast<scalar_t>(0), bsw_val = static_cast<scalar_t>(0), bse_val = static_cast<scalar_t>(0);
    scalar_t g2_tnw_val = static_cast<scalar_t>(0), g2_tne_val = static_cast<scalar_t>(0), g2_tsw_val = static_cast<scalar_t>(0), g2_tse_val = static_cast<scalar_t>(0);
    scalar_t g2_bnw_val = static_cast<scalar_t>(0), g2_bne_val = static_cast<scalar_t>(0), g2_bsw_val = static_cast<scalar_t>(0), g2_bse_val = static_cast<scalar_t>(0);
...
void launch_grid_sampler_2d_backward_backward_kernel(
  ...
  if (count > 0) {
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input.scalar_type(), "grid_sampler_2d_backward_backward_cuda", [&] {
      if (canUse32BitIndexMath(input) && canUse32BitIndexMath(grid) &&
          canUse32BitIndexMath(grad_output)) {
        grid_sampler_2d_backward_backward_kernel<scalar_t>
          <<<GET_BLOCKS(count, 256), 256, 0, at::cuda::getCurrentCUDAStream()>>>(
            static_cast<int>(count),
...
void launch_grid_sampler_3d_backward_backward_kernel(
  ...
  int64_t count = N * D * H * W;
  if (count > 0) {
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input.scalar_type(), "grid_sampler_3d_backward_backward_cuda", [&] {
      if (canUse32BitIndexMath(input) && canUse32BitIndexMath(grid) &&
          canUse32BitIndexMath(grad_output)) {
